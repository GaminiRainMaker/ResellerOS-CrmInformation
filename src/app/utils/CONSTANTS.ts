...
export const EnergyStarFlagpicklist = [
  {label: 'Not Compliant', value: 'NC'},
  {label: 'Compliant', value: 'C'},
  {label: 'Not Applicable', value: 'NA'},
];
export const EPEATFlagPickList = [
  {label: 'Non-Compliant', value: 'NC'},
  {label: 'EPEAT Certified Bronze', value: 'B'},
  {label: 'EPEAT Certified Gold', value: 'G'},
  {label: 'EPEAT Certified Silver', value: 'S'},
  {label: 'Not Applicable', value: 'NA'},
];
export const TAAFlagPickList = [
  {label: 'Compliant', value: 'C'},
  {label: 'Not Applicable', value: 'NA'},
  {label: 'Not Compliant', value: 'NC'},
];
...
export const quoteLineItemColumnForSyncFOrSalesFporceUpdatedOnce = [
  ...
  {
    value: 'rosquoteai__Energy_Star_Flag__c',
    label: 'Energy Star Flag',
  },
  {
    value: 'rosquoteai__TAA_Flag__c',
    label: 'TAA Flag',
  },
  {
    value: 'rosquoteai__Availability__c',
    label: 'Availability',
  },
  {
    value: 'rosquoteai__Description__c',
    label: 'Description',
  },
  {
    value: 'rosquoteai__Display_MPN__c',
    label: 'Display MPN',
  },
  {
    value: 'rosquoteai__End_Date__c',
    label: 'End Date',
  },
  {
    value: 'rosquoteai__Excel_Bundle_Name__c',
  ...
  {
    value: 'rosquoteai__Line_Amount__c',
    label: 'Line Amount',
  },
  {
    value: 'rosquoteai__Line_Number__c',
    label: 'Line Number',
  },
  {
    value: 'rosquoteai__Line_Type__c',
    label: 'Line Type',
  },
  {
    value: 'rosquoteai__MPN__c',
    label: 'MPN',
  },
  {
  ...
  {
    value: 'rosquoteai__Product_Code__c',
    label: 'Product Code',
  },
  {
    value: 'rosquoteai__Product_Type__c',
    label: 'Product Type',
  },
  {
    value: 'rosquoteai__Quantity__c',
    label: 'Quantity',
  },
  {
  ...
  {
    value: 'rosquoteai__Service_Duration__c',
    label: 'Service Duration',
  },
  {
    value: 'rosquoteai__Start_Date__c',
    label: 'Start Date',
  },
  {
    value: 'rosquoteai__TD__c',
    label: 'TD#',
  },
  {
