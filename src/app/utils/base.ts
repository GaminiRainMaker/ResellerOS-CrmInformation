...
export const predictionsDataaaaa = [
  {
    id: '5fe2ccbf-9dde-47c9-934d-c975f65cab8a',
    label: 'table',
    xmin: 0,
    ymin: 0,
    xmax: 0,
    ...
    cells: [
      ...
      },
      {
        ...
        ymax: 0,
        score: 0,
        text: 'Unity XT 380F DPE 25x2.5 Dell Field Rack',
        row_label: '',
        verification_status: 'correctly_predicted',
        status: '',
        failed_validation: '',
      ...
      },
      {
        ...
        ymax: 0,
        score: 0,
        text: 'Unity 380F DPE Install Kit',
        row_label: '',
        verification_status: 'correctly_predicted',
        status: '',
        failed_validation: '',
      ...
      },
      {
        ...
        ymax: 0,
        score: 0,
        text: 'Pair of C13/C14 cables (Highline Power) or C19/C20 cables (480/680 Lowline Power) included with DPE',
        row_label: '',
        verification_status: 'correctly_predicted',
        status: '',
        failed_validation: '',
      ...
      },
      {
        ...
        ymax: 0,
        score: 0,
        text: 'PARTS ONLY WARRANTY 36 MONTHS',
        row_label: '',
        verification_status: 'correctly_predicted',
        status: '',
        failed_validation: '',
      ...
      },
      {
        ...
        ymax: 0,
        score: 0,
        text: 'PROSUPPORT AND NEXT BUSINESS DAY ONSITE SERVICE INITIAL',
        row_label: '',
        verification_status: 'correctly_predicted',
        status: '',
        failed_validation: '',
      ...
      },
      {
        ...
        ymax: 0,
        score: 0,
        text: 'Partner Success Program Management',
        row_label: '',
        verification_status: 'correctly_predicted',
        status: '',
        failed_validation: '',
      ...
      },
      {
        ...
        ymax: 0,
        score: 0,
        text: 'ProDeploy Plus No Charge Training 800',
        row_label: '',
        verification_status: 'correctly_predicted',
        status: '',
        failed_validation: '',
      ...
      },
      {
        ...
        ymax: 0,
        score: 0,
        text: 'CoDeliver - ProDeploy Plus for Dell EMC Unity X80 DPE Hybrid and All Flash',
        row_label: '',
        verification_status: 'correctly_predicted',
        status: '',
        failed_validation: '',
      ...
      },
      {
        ...
        ymax: 0,
        score: 0,
        text: 'Unity F 1.92TB ALL FLASH 25X2.5 SSD',
        row_label: '',
        verification_status: 'correctly_predicted',
        status: '',
        failed_validation: '',
      ...
      },
      {
        ...
        ymax: 0,
        score: 0,
        text: 'Unity 2X4 Port IO 25GbE Twinax AF',
        row_label: '',
        verification_status: 'correctly_predicted',
        status: '',
        failed_validation: '',
      ...
      },
      {
        ...
        ymax: 0,
        score: 0,
        text: 'C13 Power Cord Pair NEMA5-15P plugs 2Mtr',
        row_label: '',
        verification_status: 'correctly_predicted',
        status: '',
        failed_validation: '',
      ...
      },
      {
        ...
        ymax: 0,
        score: 0,
        text: '3M SFP+ to SFP+ 25G Passive Twinax CBL AF',
        row_label: '',
        verification_status: 'correctly_predicted',
        status: '',
        failed_validation: '',
