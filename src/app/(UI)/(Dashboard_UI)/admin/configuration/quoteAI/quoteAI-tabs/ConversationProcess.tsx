          ...
          items={[
            {
              key: '1',
              label: (
                <Typography name="Body 2/Medium">Attachment Process</Typography>
              ),
              children: (
                <Space
                  size={4}
          ...
          items={[
            {
              key: '2',
              label: (
                <Typography name="Body 2/Medium">OEM Configuration </Typography>
              ),
              children: (
              ...
              children: (
                ...
                >
                  <Space direction="vertical" size={4} style={{width: '100%'}}>
                    <Typography name="Body 4/Medium">Price Book ID</Typography>
                    <OsInput placeholder="Write here!" />
                  </Space>
                  <Space direction="vertical" size={4} style={{width: '100%'}}>
                    <Typography name="Body 4/Medium">Match Criteria</Typography>
                    <OsInput placeholder="Write here!" />
                  </Space>
                  <Space size={8}>
                    <Checkbox />
