    ...
    await dispatch(getAllProductForContract({query: searchQuery}))?.then(
      (payload: any) => {
        ...
        if (payload?.payload?.length > 0) {
          setShowButtonForContract(true);
        } else {
          setShowButtonForContract(false);
        }
        ...
        {productOptions?.length === 0 ? (
          <>
            ...
            >
              ...
              >
                Please Add Product first to add contract product !
              </Typography>
            </Row>
          </>
        ) : (
              ...
              >
                <Row justify="space-between" gutter={[24, 24]}>
                  <Col sm={24} md={drawer ? 24 : 12}>
                    <SelectFormItem
                      label={
                        <Typography name="Body 4/Medium">Contract</Typography>
                      }
                      name="contract_id"
                      rules={[
                        {
                  ...
                  <Col sm={24} md={drawer ? 24 : 12}>
                    <SelectFormItem
                      label={
                        <Typography name="Body 4/Medium">Product</Typography>
                      }
                      name="product_id"
                      rules={[
                        {
