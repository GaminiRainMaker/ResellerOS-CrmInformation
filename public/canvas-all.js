...
(function (global) {
  ...
  var oproto = Object.prototype,
    ...
    $ = {
      ...
      userAgent: (function () {
        ...
        return {
          isIE: isIE,
          isIE11: isIE && ieVersion == 11,
          isIE10: isIE && ieVersion == 10,
          isIE9: isIE && ieVersion == 9,
          isIE8: isIE && ieVersion == 8,
          isIE7: isIE && ieVersion == 7,
          isIE6: isIE && ieVersion == 6,
          ieVersion: ieVersion,
          isWebkit: isWebkit,
          isChrome: isChrome,
          isChromeFrame: isChrome && typeof global.externalHost != 'undefined',
          isChromium: isChromium,
          isSafari: isSafari,
          isSafari3: isSafari && ua.indexOf('Version/3') != -1,
          isSafariIpad: isWebkit && ua.indexOf('iPad') != -1,
          isSafariIOS:
            isSafari &&
            (ua.indexOf('iPad') != -1 || ua.indexOf('iPhone') != -1),
          isFirefox: isFirefox,
          isFirefox3: isFirefox && ua.indexOf('Firefox/3') != -1,
      ...
      _handleXDR: function (url, config) {
        ...
        if (
          $.isFunction(config.beforerequest) &&
          !config.beforerequest.call(config.context)
        ) {
          return;
        }
        if (xdr) {
        ...
        if (config.data) {
          if (config.method === 'GET' || config.method === 'HEAD') {
            ...
            if (!$.isString(config.data) && config.processData) {
              config.data = $.generateQueryString('', config.data, {
                includeMark: false,
                escape: config.escape,
                allowMultipleOfParam: true,
              });
            }
          }
        }
    ...
    function tryScroll() {
      ...
      try {
        if (
          ...
          global.document.documentElement.doScroll
        ) {
  ...
  (function () {
    ...
    var console =
      typeof global !== 'undefined' && global.console ? global.console : {};
    while (length--) {
