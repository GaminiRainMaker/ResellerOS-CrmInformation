declare namespace Sfdc {
  ...
  namespace canvas {
    ...
    interface Auxiliary {
      readonly appApprovalType: string
      readonly appInstallType: string
      idpInitiatedUrl: string | null
    }
    ...
    function size(
      obj: ArrayLike<unknown> | Record<string, unknown> | null | undefined,
    ): number
    ...
    namespace client {
      ...
      function refreshSignedRequest(
        cb: (
          data: Response<{ response: string; auxiliary: Auxiliary }>,
        ) => void,
      ): void
