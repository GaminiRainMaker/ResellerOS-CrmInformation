...
const quoteLineItemSlice = createSlice({
  ...
  extraReducers(builder) {
    builder
      ...
      .addCase(deleteQuoteLineItemsByQuoteId.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(
        deleteQuoteLineItemsByQuoteId.fulfilled,
        (state, action: PayloadAction<any>) => {
          state.loading = false;
          state.data = action.payload;
        },
      ...
      .addCase(deleteLineItemsByQuoteFileId.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(
        deleteLineItemsByQuoteFileId.fulfilled,
        (state, action: PayloadAction<any>) => {
          state.loading = false;
          state.data = action.payload;
        },
      ...
      .addCase(
        deleteLineItemsByQuoteFileId.rejected,
        (state, action: PayloadAction<any>) => {
          state.loading = false;
          state.error = action.payload;
        },
